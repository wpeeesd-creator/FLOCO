...
export default function ExchangeAlertScreen() {
  ...
  const styles = StyleSheet.create({
    ...
    banner: { alignItems: 'center', paddingHorizontal: 32, paddingTop: 32, paddingBottom: 24 },
    bannerIcon: {
      width: 64, height: 64, borderRadius: 32, backgroundColor: '#EBF4FF',
      alignItems: 'center', justifyContent: 'center', marginBottom: 16,
    },
    bannerTitle: { fontSize: 20, fontWeight: '700', color: Colors.text, marginBottom: 8, textAlign: 'center' },
    bannerDesc: { fontSize: 14, color: Colors.textSub, textAlign: 'center', lineHeight: 20 },
    rateCard: {
    ...
    rateCardValue: { fontSize: 20, fontWeight: '700', color: Colors.text, fontFamily: 'Courier' },
    rateCardBadge: { paddingHorizontal: 12, paddingVertical: 6, backgroundColor: '#EBF4FF', borderRadius: 20 },
    rateCardBadgeText: { fontSize: 13, fontWeight: '700', color: Colors.primary },
    directInputBtn: {
      marginHorizontal: 16, marginTop: 12, height: 52, borderRadius: 14,
      borderWidth: 1.5, borderColor: Colors.primary,
      flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8,
      backgroundColor: Colors.card,
    },
    directInputText: { fontSize: 15, fontWeight: '600', color: Colors.primary },
    alertSection: { marginHorizontal: 16, marginTop: 24 },
    alertSectionTitle: { fontSize: 15, fontWeight: '700', color: Colors.text, marginBottom: 12 },
    emptyState: { backgroundColor: Colors.card, borderRadius: 16, paddingVertical: 40, alignItems: 'center', gap: 8 },
    emptyTitle: { fontSize: 15, fontWeight: '600', color: Colors.textSub },
    emptyDesc: { fontSize: 13, color: Colors.textMuted, textAlign: 'center' },
    alertList: { backgroundColor: Colors.card, borderRadius: 16, overflow: 'hidden' },
    alertItem: {
      flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between',
    ...
    alertToggle: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 12 },
    alertToggleText: { fontSize: 11, fontWeight: '700', color: theme.bgCard },
    bottomContainer: {
    ...
    subscribeBtnText: { fontSize: 16, fontWeight: '700', color: theme.bgCard },
  });
    ...
    <SafeAreaView style={styles.root}>
      ...
      <View style={styles.bottomContainer}>
        <TouchableOpacity
          ...
          activeOpacity={0.8}
        >
          <Ionicons name="notifications" size={18} color={theme.bgCard} />
